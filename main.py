...
shuffle (radio_list)
q1 = Question('40+45', '85', '70', '90', '346')
q2 = Question('Машина', 'car', 'cary', 'caryca', 'mashyna')
q3 = Question('Чим ми пічатаємо', 'руками', 'клавіатурою', 'мишкою', 'ногою')
q4 = Question('Скільки памяті в компютері', 'порізному', '1тб', '2тб', '512')
